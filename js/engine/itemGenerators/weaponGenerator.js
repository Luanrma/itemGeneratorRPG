...
import { armorAndWeaponsStatusGeneratorByLevel as weaponGenerator } from '../leveling.js';
...
export default {
    generateItem: function (playerLevel) {
        ...
        const selectedOpts = [];
        const model = this.translateWeapon(this.getRandomWeaponType());
        ...
        for (let i = 1; i <= optsCount; i++) {
            ...
            const statusItem = ` + ${weaponGenerator(playerLevel)}`;
